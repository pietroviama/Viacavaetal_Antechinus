...
PCAanteplot <- plot(PCAante$pc.scores[,1], PCAante$pc.scores[,34], col = cols_dat, pch = c(16:17)[factor(gdfante$Sex)], cex = 2, asp = T, xlab="Principal Component 1 (19.58%)", ylab="Principal Component 2 (8.39%)")
text(PCAante$pc.scores[,1], PCAante$pc.scores[,34], labels=gdfante$ID, pos=4)
...
JM19758.pts<-A_reorder[,,"JM19758"]
open3d()
spheres3d(JM19758.pts,radius = 0.2,col = 1)
text3d(JM19758.pts, texts = c(1:82), asp = FALSE, cex = 2, col="blue", pos = 3)
