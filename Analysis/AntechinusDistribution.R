...
map2 <- 
  ...
  scale_fill_manual(values = c("grey", "red", "blue", "hotpink1", "darkgreen", "orange"), labels=c("?", "stuartii north", "stuartii south", "stuartii neotype", "subtropicus", "subtropicus holotype"), name=NULL) +
  geom_text(data=antechinusdata, 
