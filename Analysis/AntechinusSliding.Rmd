...
#knitr::opts_knit$set(root.dir = '../Users/pietro/Desktop/Pietro/Projects/Viacavaetal_Antechinus/Data', echo = TRUE)
...
text3d(Ants[,,7], texts = c(1:82), asp=FALSE, cex=3, col="blue", pos = 3 )
...
names_reorder== Plylist

#Check if coords and specimesn still correspond - all good
Check_plotspec <- read.ply("../Data/3Dmodels/AntechinusTest/CM3713.ply")
plotspec(Check_plotspec, data_reorder[,,2])

dimnames(data_reorder)[[3]]

lmplacement<-placePatch(Atlas,data_reorder,path="../Data/3Dmodels/AntechinusTest/", inflate=1) #ray=TRUE for projection along surface normals instead of closest point
